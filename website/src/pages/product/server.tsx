...
import SprinklesHome from '../../components/SprinklesHome'
                    ...
                    <div className="container v-prop__container">
                        <div className="row d-flex flex-row-reverse" id="code-search">
                            <div className="col-md-6">
                                <img width="100%" src="https://images.ctfassets.net/le3mxztn6yoo/1pVAB22cRSqGCQsyiOgKM8/057eb0369d062e9c28579bf2942aa7e9/DiffSearchGif.gif"/>
                            </div>
                            <div className="col-md-6">
                ...
                <div className="product__server__feature-block product__server__feature-block--border-bottom border-bottom">
                    <div className="container v-prop">
                        <div className="row" id="code-intelligence">
                            <div className="col-md-6">
                                <img width="100%" src="https://images.ctfassets.net/le3mxztn6yoo/5h679xU1pmMAmaG2q8Ye6s/0e54491e42ba0dc26e7ae4f95e1558e4/PRCodeIntelligence.gif" />
                            </div>
                            <div className="col-md-6">
