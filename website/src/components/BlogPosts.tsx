                                ...
                                <div className="blog__posts--container" role="article">
                                    <div className="blog__posts--post">
                                        ...
                                        <div className="blog__posts--post-image">
                                            <div style={{position: 'relative', overflow: 'hidden', maxHeight: '250px' }}>
                                                <div style={{width: '100%', paddingBottom:'93.90070921985814%'}}/>
                                                <img src={post.node.frontmatter.heroImage} style={{ position: 'absolute', top: '0px', left: '0px', width: '100%', height: '100%', objectFit: 'contain', objectPosition: 'center center',  maxHeight: '250px', borderRadius: '0.25rem' }}/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
